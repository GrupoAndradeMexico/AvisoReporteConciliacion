	...
	public class FtpClient
	{
		...
		public void Login()
		{
			...
			catch(Exception ex)
			{
                ...
                //Utilerias.WriteToLog(ex.Message, "Login dentro del FtpClient", "C:\\BI\\CachaYEnvia\\Log.txt");
            ...
            //Utilerias.WriteToLog("Conectado a " + this.server + " intento de cambio de directorio a " + this.remotePath, "Login dentro del FtpClient", "C:\\BI\\CachaYEnvia\\Log.txt");
